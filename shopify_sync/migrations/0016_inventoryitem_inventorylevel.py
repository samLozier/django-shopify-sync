    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country_code_of_origin', models.CharField(blank=True, max_length=2, null=True)),
                ('country_harmonized_system_codes', models.CharField(blank=True, max_length=200, null=True)),
                ('created_at', models.DateTimeField(null=True)),
                ('harmonized_system_code', models.CharField(blank=True, max_length=50, null=True)),
                ('province_code_of_origin', models.CharField(blank=True, max_length=2, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('inventory_item_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='shopify_sync.inventoryitem')),
                ('session', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='shopify_sync.session')),
            ],
            bases=(shopify_sync.models.base.ChangedFields, models.Model),
        ),
