...
class Metafield(ShopifyDatedResourceModel):
    ...
    owner_resource = models.CharField(
        max_length=32, choices=OWNER_RESOURCE_CHOICES, default=OWNER_RESOURCE_SHOP
    )
    value = models.TextField()
    value_type = models.CharField(
        max_length=32, choices=VALUE_TYPE_CHOICES, default=VALUE_TYPE_STRING
    )
    product = models.ForeignKey(
        "shopify_sync.Product", null=True, on_delete=models.CASCADE
    )
