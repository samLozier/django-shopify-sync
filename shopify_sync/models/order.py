...
class Order(ShopifyDatedResourceModel):
    ...
    customer = models.ForeignKey(
        "shopify_sync.Customer", null=True, on_delete=models.CASCADE
    )
    discount_codes = JSONField(
    ...
    note_attributes = JSONField(
        dump_kwargs={"cls": ShopifyDjangoJSONEncoder}, null=True
    )
    ...
    def calculate_refund(self, line_items=None):
        ...
        for line in line_items:
            refund_lines.append({"line_item_id": line.id, "quantity": line.quantity})
